...
````{r, echo = F}
mhb_baseurl <- 'https://www.statistik.tu-dortmund.de/fileadmin/user_upload/Studium/Studiengaenge-Infos/MHB_Econometrics_full.pdf#page='
...
# Set flag symbols
Kurse$Sprache[Kurse$Sprache == "deutsch"] <- "DE"
Kurse$Sprache[Kurse$Sprache == "englisch"] <- "EN"
Kurse$Sprache[Kurse$Sprache == "deutsch/englisch"] <- "DE/EN"
